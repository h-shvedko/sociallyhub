...
- `SocialAccount` access/refresh tokens stored plaintext (schema comments claim "Encrypted") — ADR-0006; `IntegrationSetting.credentials` stored unencrypted (masked on read only).
